...
import pytorch_ssim
from data_utils import TrainDatasetFromFolder, ValDatasetFromFolder, display_transform, init_aux
from loss import GeneratorLoss
from model import Generator, Discriminator, NLayerDiscriminator, PixelDiscriminator
...
train_set = TrainDatasetFromFolder('data/' + str(UPSCALE_FACTOR) + '/train/', crop_size = CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
val_set = ValDatasetFromFolder('data/' + str(UPSCALE_FACTOR) + '/val/', upscale_factor=UPSCALE_FACTOR)
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    netG.eval()
    out_path = 'results/' + str(UPSCALE_FACTOR) + 'x'
